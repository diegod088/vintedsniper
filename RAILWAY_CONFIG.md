...
COOKIE_FILE=/app/data/cookies/vinted.json
...
4. Añade TODAS las variables listadas arriba (incluyendo `VINTED_COOKIES` y `COOKIE_FILE`)

### 2. Crear el Volumen Unico
